...
<form class="form" action="enviarprodutos.php" method="post" enctype="multipart/form-data">
...
Selecione a imagem do produto: <input type="file" name="imagem"><br>
    

      <button type="submit" value="Enviar">Enviar Dados</button>
