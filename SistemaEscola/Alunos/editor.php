...
<body style="background-color:black">
  ...
  <div style="background-color:whitesmoke;border-style: double;color: black;"
    ...
    <div class="col-sm-12 text-center text-break">
      ...
      <form style="padding-top:18px;" method="post" action="envio(editar).php" id="formlogin" name="formlogin">
        <fieldset id="fie">
          <div class="form-group">
            <img src="Icone.png" align="center" width="100px" height="100px" alt="">
            <p class="p-2"></p>
            <p class="p-0.5"></p>
          ...
          <br>
          <div class="form-group">
            <input type="text" class="form-control" name="id" placeholder="Informe o Id do Aluno para confirmar a alteração">
          </div>
          <br>
          <p class="p-0.5"></p>
          <button type="submit" class="btn btn-outline-dark" value="alterar">Alterar</button>
          <p class="p-0.5"></p>
          <p class="p-2"></p>
        </fieldset>
      </form>
